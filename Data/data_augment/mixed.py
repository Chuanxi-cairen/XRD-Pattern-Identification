...
class MixedGen(object):
    ...
    def __init__(self, struc, max_shift=0.5, max_strain=0.04, min_domain_size=1, max_domain_size=100, max_texture=0.6, impur_amt=70.0, min_angle=10.0, max_angle=80.0):
        """
        Args:
        ...
        self.struc = [struc] if isinstance(struc, Structure) else struc
    ...
    def strained_struc(self):
        ref_struc = self.struc[0].copy()  # Take the first structure in the list.
